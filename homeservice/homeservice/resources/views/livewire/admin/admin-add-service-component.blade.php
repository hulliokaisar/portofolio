                            ...
                            <div class="panel panel-default">
                                <div class="panel-heading">
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <a href="{{route('admin.all-services')}}" class="btn btn-info pull-right">All Categories</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="panel-body">
                                    ...
                                    <form action="" class="form-horizontal" wire:submit.prevent="createService">
                                        ...
                                        <div class="form-group">
                                            <label for="discount_type" class="control-label col-sm-3">Discount: </label>
                                            <div class="col-sm-9">
                                                <select name="" id="" class="form-control" wire:model="discount_type">
                                                    <option value="">Select service category</option>
