                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <aside>
                                <h4>The Office</h4>
                                <address>
                                    <strong>Begin Services.</strong><br>
                                    <i class="fa fa-map-marker"></i><strong>Address: </strong>Cimahi, Jawa Barat,
                                    Indonesia<br>
                                    <i class="fa fa-phone"></i><strong>Phone: </strong> +62-88224464843
                                </address>
                                <address>
                                    <strong>Begin Emails</strong><br>
                                    <i class="fa fa-envelope"></i><strong>Email:</strong><a
                                        href="mailto:kaisarhullio@gmail.com"> kaisarhullio@gmail.com</a><br>
                                </address>
                            </aside>
                            <hr class="tall">
                        </div>
